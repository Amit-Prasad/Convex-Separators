...
from helpers import feature_engineer_quadratic_fetch, featurewise_normalisation_fetch
import os

def get_dataset(name, feature, norm):
    if name == 'circle':
    ...
    if name == 'triangle':
        data = pd.read_csv('../datasets/triangle.csv', header=None).values
        data_x = data[:, 0:-1]
        data_y = data[:, -1]
        data_y = np.where(data_y == -1, 0, 1)
        data_x, data_x_test, data_y, data_y_test = train_test_split(data_x, data_y, test_size=0.30, random_state=1)
    ...
    if name == 'hexagon':
        data = pd.read_csv('../datasets/hexagon.csv', header=None).values
        data_x = data[:, 0:-1]
        data_y = data[:, -1]
        data_y = np.where(data_y == -1, 0, 1)
        data_x, data_x_test, data_y, data_y_test = train_test_split(data_x, data_y, test_size=0.30, random_state=1)
    ...
    if name == 'square':
        data = pd.read_csv('../datasets/square.csv', header=None).values
        data_x = data[:, 0:-1]
        data_y = data[:, -1]
        data_y = np.where(data_y == -1, 0, 1)
        data_x, data_x_test, data_y, data_y_test = train_test_split(data_x, data_y, test_size=0.30, random_state=1)
    ...
    if name == 'pentagon':
        data = pd.read_csv('../datasets/pentagon.csv', header=None).values
        data_x = data[:, 0:-1]
        data_y = data[:, -1]
        data_y = np.where(data_y == -1, 0, 1)
        data_x, data_x_test, data_y, data_y_test = train_test_split(data_x, data_y, test_size=0.30, random_state=1)
    ...
    if name == 'diamond':
        data = pd.read_csv('../datasets/diamond.csv', header=None).values
        data_x = data[:, 0:-1]
        data_y = data[:, -1]
        data_y = np.where(data_y == -1, 0, 1)
        data_x, data_x_test, data_y, data_y_test = train_test_split(data_x, data_y, test_size=0.30, random_state=1)
    ...
    if name == 'ellipse':
        data = pd.read_csv('../datasets/ellipse.csv', header=None).values
        data_x = data[:, 0:-1]
        data_y = data[:, -1]
        data_y = np.where(data_y == -1, 0, 1)
        data_x, data_x_test, data_y, data_y_test = train_test_split(data_x, data_y, test_size=0.30, random_state=1)
    ...
    if name == 'ellipsoid':
        data = pd.read_csv('../datasets/ellipsoid.csv', header=None).values
        data_x = data[:, 0:-1]
        data_y = data[:, -1]
        data_y = np.where(data_y == -1, 0, 1)
        data_x, data_x_test, data_y, data_y_test = train_test_split(data_x, data_y, test_size=0.30, random_state=1)
    ...
    if name == 'ellipsoid_7D':
        data = pd.read_csv('../datasets/ellipsoid_7D.csv', header=None).values
        data_x = data[:, 0:-1]
        data_y = data[:, -1]
        data_y = np.where(data_y == -1, 0, 1)
        data_x, data_x_test, data_y, data_y_test = train_test_split(data_x, data_y, test_size=0.30, random_state=1)
    ...
    if name == 'sphere_7D':
        data = pd.read_csv('../datasets/sphere_7D.csv', header=None).values
        data_x = data[:, 0:-1]
        data_y = data[:, -1]
        data_y = np.where(data_y == -1, 0, 1)
        data_x, data_x_test, data_y, data_y_test = train_test_split(data_x, data_y, test_size=0.30, random_state=1)
    ...
    if name == 'half_moons':
        data = pd.read_csv('../datasets/half_moons.csv', header=None).values
        data_x = data[:, 0:-1]
        data_y = data[:, -1]
        data_y = np.where(data_y == -1, 0, 1)
        data_x, data_x_test, data_y, data_y_test = train_test_split(data_x, data_y, test_size=0.30, random_state=1)
    ...
    if name == 'four_circles_non_linear':
        data = pd.read_csv('../datasets/four_circles_non_linear.csv', header=None).values
        data_x = data[:, 0:-1]
        data_y = data[:, -1]
        data_y = np.where(data_y == -1, 0, 1)
        if feature==2:
            data_x = feature_engineer_quadratic_fetch(data_x)
            if norm == 1:
                data_x = featurewise_normalisation_fetch(data_x)
        data_x, data_x_test, data_y, data_y_test = train_test_split(data_x, data_y, test_size=0.30, random_state=1)
        return data_x, data_y, data_x_test, data_y_test

    if name == 'five_circles_non_linear':
        data = pd.read_csv('../datasets/five_circles_non_linear.csv', header=None).values
        data_x = data[:, 0:-1]
        data_y = data[:, -1]
        data_y = np.where(data_y == -1, 0, 1)
        data_x, data_x_test, data_y, data_y_test = train_test_split(data_x, data_y, test_size=0.30, random_state=1)
    ...
    if name == 'overlapping_parabolas':
        data = pd.read_csv('../datasets/overlapping_parabolas.csv', header=None).values
        data_x = data[:, 0:-1]
        data_y = data[:, -1]
        data_y = np.where(data_y == -1, 0, 1)
        data_x, data_x_test, data_y, data_y_test = train_test_split(data_x, data_y, test_size=0.30, random_state=1)
    ...
    if name == 'quadrilateral':
        data = pd.read_csv('../datasets/quadrilateral.csv', header=None).values
        data_x = data[:, 0:-1]
        data_y = data[:, -1]
        data_y = np.where(data_y == -1, 0, 1)
        if feature==2:
    ...
    if name == 'corner_square':
        data = pd.read_csv('../datasets/corner_square.csv', header=None).values
        data_x = data[:, 0:-1]
        data_y = data[:, -1]
        data_y = np.where(data_y == -1, 0, 1)
        if feature==2:
    ...
    if name == "covtype":
        data = pd.read_csv('../datasets/covtype.data', header=None).sample(frac=1).values
        x_train, x_test, y_train, y_test = train_test_split(data[:, 0:-1], data[:, -1].astype('int')-1, test_size=0.30, random_state=1)
        x_train = x_train / np.amax(abs(x_train), axis=0)
        x_test = x_test / np.amax(abs(x_test), axis=0)
